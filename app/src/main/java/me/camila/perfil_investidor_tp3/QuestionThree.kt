...
class QuestionThree : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_question_three, container, false)

        val btSend = view.findViewById<Button>(R.id.btSend3)
        ...
        btSend.setOnClickListener {
            ...
            if (check) {
                ...
                navController.navigate(R.id.action_questionThree_to_questionFour, bundle)
