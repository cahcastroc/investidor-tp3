...
class QuestionSeven : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_question_seven, container, false)

        val btSend = view.findViewById<Button>(R.id.btSend7)
        ...
        btSend.setOnClickListener {
            ...
            if (check) {
                ...
                navController.navigate(R.id.action_questionSeven_to_questionEight, bundle)
