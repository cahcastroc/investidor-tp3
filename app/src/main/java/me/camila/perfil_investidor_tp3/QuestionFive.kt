...
class QuestionFive : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_question_five, container, false)

        val btSend = view.findViewById<Button>(R.id.btSend5)
        ...
        btSend.setOnClickListener {
            ...
            if (check) {
                ...
                navController.navigate(R.id.action_questionFive_to_questionSix, bundle)
