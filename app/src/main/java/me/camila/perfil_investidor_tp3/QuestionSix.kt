...
class QuestionSix : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_question_six, container, false)

        val btSend = view.findViewById<Button>(R.id.btSend6)
        ...
        btSend.setOnClickListener {
            ...
            if (check) {
                ...
                navController.navigate(R.id.action_questionSix_to_questionSeven, bundle)
